...
int main()
{
	char email[] = "vmario@126.com"; /*收件人邮箱*/
...
//	hostent *host;
...
#if 0
	their_addr.sin_addr.s_addr = *(struct in_addr*)host->h_addr;//126 smtp 服务器
#else
	their_addr.sin_addr.s_addr = inet_addr("123.58.178.202"); //126 smtp 服务器
#endif
	...
	// PASSWORD
	sprintf(buf, "digital2050");//你的126 邮箱密码
	memset(pass, 0, 128);
